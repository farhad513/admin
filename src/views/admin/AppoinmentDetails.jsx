...
import { get_admin_appoinment, admin_appoinment_status_update, messageClear } from '../../store/Reducers/AppoinmentReducer'
const OrderDetails = () => {

    const { appoinmentId } = useParams()
    const dispatch = useDispatch()

    const { order, errorMessage, successMessage } = useSelector(state => state.appoinment)

    useEffect(() => {
        dispatch(get_admin_appoinment(appoinmentId))
    }, [appoinmentId])
    ...
    const status_update = (e) => {
        dispatch(admin_appoinment_status_update({ appoinmentId, info: { status: e.target.value } }))
